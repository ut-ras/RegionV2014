...
if("TRUE" STREQUAL "TRUE")
  set(pathing_SOURCE_PREFIX /home/ras/regionV2014/src/pathing)
  set(pathing_DEVEL_PREFIX /home/ras/regionV2014/devel)
  set(pathing_INSTALL_PREFIX "")
  set(pathing_PREFIX ${pathing_DEVEL_PREFIX})
else()
  set(pathing_SOURCE_PREFIX "")
  set(pathing_DEVEL_PREFIX "")
  set(pathing_INSTALL_PREFIX /home/ras/regionV2014/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pathing' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ras <ras@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'pathing' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ras/regionV2014/src/pathing/${idir}'.  Ask the maintainer 'ras <ras@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${pathing_dep}_FOUND)
      find_package(${pathing_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${pathing_dep} REQUIRED ${depend_list})
  endif()
  _list_append_unique(pathing_INCLUDE_DIRS ${${pathing_dep}_INCLUDE_DIRS})
  list(APPEND pathing_LIBRARIES ${${pathing_dep}_LIBRARIES})
...
if(pathing_LIBRARIES)
  _remove_duplicate_libraries(pathing_LIBRARIES pathing_LIBRARIES)
endif()
